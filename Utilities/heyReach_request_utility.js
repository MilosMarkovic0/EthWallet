async function logInLinkedInAccount() {
    ...
    /* Registering the account to the tenant in linkedIn */
    const endpoint = '/LinkedInAccount/CreateLinkedInAccountFromCookies';
    return makelinkedInRequest(endpoint, {}, payload, "POST")
        .catch(err => {
            // todo: handle errors
...
/**
 * Checks if the logged in LinkedIn accounts is connected to the logged in linkedIn account
...
const checkIfAccountIsConnected = async () => {
    ...
    return makelinkedInRequest(endpoint, {}, undefined, "GET")
...
const testCustomProxy = (proxyConfig) => {
    ...
    return makelinkedInRequest(endpoint, {}, proxyConfig, "POST")
        .catch(() => {
...
const checkIfSubscriptionRequiresCustomProxy = async () => {
    ...
    await makelinkedInRequest(endpoint, {}, {}, "GET")
